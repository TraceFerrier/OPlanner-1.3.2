...
{
    public static class MouseDownStyle
    {
        public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.RegisterAttached("IsEnabled",
        typeof(bool), typeof(MouseDownStyle), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(OnNotifyPropertyChanged)));
        ...
        static void element_MouseRightButtonDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            var element = e.Source as UIElement;
            if (element != null)
            {
        ...
        private static void element_MouseLeave(object sender, System.Windows.Input.MouseEventArgs e)
        {
            ...
            if (element != null)
            {
                ...
                SetIsMouseRightButtonDown(element, false);
            }
        }
        ...
        typeof(bool), typeof(MouseDownStyle), new FrameworkPropertyMetadata(false));
        ...
        internal static readonly DependencyPropertyKey IsMouseRightButtonDownPropertyKey = DependencyProperty.RegisterAttachedReadOnly("IsMouseRightButtonDown",
        typeof(bool), typeof(MouseDownStyle), new FrameworkPropertyMetadata(false));
        public static readonly DependencyProperty IsMouseRightButtonDownProperty = IsMouseRightButtonDownPropertyKey.DependencyProperty;
        ...
        internal static void SetIsMouseRightButtonDown(UIElement element, bool value)
        {
            element.SetValue(IsMouseRightButtonDownPropertyKey, value);
        }
        ...
        public static bool GetIsMouseRightButtonDown(UIElement element)
        {
            return (bool)element.GetValue(IsMouseRightButtonDownProperty);
        }
    }
}
