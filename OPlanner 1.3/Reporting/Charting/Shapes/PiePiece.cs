...
namespace PlannerNameSpace
{
    ...
    class PiePiece : Shape
    {
        ...
        {           
            ...
            Point innerArcStartPoint = ReportingUtils.ComputeCartesianCoordinate(RotationAngle, InnerRadius);
            innerArcStartPoint.Offset(CentreX, CentreY);

            Point innerArcEndPoint = ReportingUtils.ComputeCartesianCoordinate(RotationAngle + WedgeAngle, InnerRadius);
            innerArcEndPoint.Offset(CentreX, CentreY);

            Point outerArcStartPoint = ReportingUtils.ComputeCartesianCoordinate(RotationAngle, Radius);
            outerArcStartPoint.Offset(CentreX, CentreY);

            Point outerArcEndPoint = ReportingUtils.ComputeCartesianCoordinate(RotationAngle + WedgeAngle, Radius);
            ...
            if (PushOut > 0)
            {
                Point offset = ReportingUtils.ComputeCartesianCoordinate(RotationAngle + WedgeAngle / 2, PushOut);
